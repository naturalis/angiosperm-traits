...
```{r}
# BM
phyloglm(formula = woody_formula_24a, data = GIS_woody, phy = tree_woody, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = TRUE)

#OU
phyloglm(formula = , data = GIS_woody, phy = tree_woody, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = TRUE)
```
...
# BM
model_BM_woody <- phyloglm()
check_model(model_BM_woody)

# OU
model_OU_woody <- phyloglm()
...
```{r}
# BM
phyloglm(formula = , data = GIS_crops, phy = tree_crops, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = TRUE)
...
#BM
model_BM_crops <- phyloglm()
check_model(model_BM_crops)

#OU
model_OU_crops <- phyloglm()
...
```{r}
# BM
phyloglm(formula = , data = GIS_myco, phy = tree_myco, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = TRUE)
...
# BM
model_BM_myco <- phyloglm()
check_model(model_BM_myco)

# OU
model_OU_myco <- phyloglm()
