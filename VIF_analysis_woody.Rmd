...
### Add back BIO6 (30) 
This increases the VIF value of PETseasonality and BIO6 has a high VIF value as well. But it is not necessary to include this in the analysis, we have three other PET variables. But if we really want BIO6 in the analysis, we will have to delete: PETseasonality (18) and ClimaticMoistureIndex (8)
```{r}
...
```
Or, if we want to keep ClimaticMoistureIndex: PETseasonality (18), BIO18 (42), monthCountByTemp10 (15), and BIO14 (38)
```{r}
