...
tree_myco_temp <- drop.tip(tree, tips_to_drop_myco)
```
...
phylostep(formula = , starting.formula = mycorrhiza ~ 1, data = GIS_myco, phy = tree_myco, model = "BM", direction = "both", trace = 2)
```
...
#define formula components and run function (forward)
phylostep(formula = , starting.formula = mycorrhiza ~ 1, data = GIS_myco, phy = tree_myco, model = "OUrandomRoot", direction = "forward", trace = 2)

#define formula components and run function (both)
phylostep(formula = , starting.formula = mycorrhiza ~ 1, data = GIS_myco, phy = tree_myco, model = "OUrandomRoot", direction = "both", trace = 2)
```
...
#define formula components and run function (forward)
phylostep(formula = , starting.formula = mycorrhiza ~ 1, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "forward", trace = 2)

#define formula components and run function (both)
phylostep(formula = , starting.formula = mycorrhiza ~ 1, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "both", trace = 2)
```
