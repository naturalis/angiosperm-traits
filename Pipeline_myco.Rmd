...
```{r define formula}
# Formula 2. With embergerQ (alpha warning, AIC 1026,5)
...
# Formula 4. With continentality (no alpha warning, AIC 1037,3)
...
```
NB: Both these formulas can be used, they result in the same final model. 
...
phyloglmstep(myco_formula_2, starting.formula = NULL, data=GIS_myco, phy=tree_myco, 
...
### Define final model
```{r}
final_model_myco_1 <- mycorrhiza ~ - 0.58705 - 0.57211*ClayPercentage -0.64992*bio2 + 0.55083*bio15
```
