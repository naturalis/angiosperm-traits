...
```{r}
#source function
source('phyloglmsep.R')

#fill in arguments and execute function
phyloglmstep(myco_formula_24a, starting.formula = NULL, data=GIS_myco, phy=tree_myco, 
...
model_myco <- phyloglm(formula = , data = GIS_myco, phy = tree_myco, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = )
