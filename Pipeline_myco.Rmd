...
```{r define formula}
# Formula 3. With continentality (alpha warning, AIC 1026,5) (no alpha warning AIC 1037,3)
myco_formula_3 <- mycorrhiza ~ Aspect + BulkDensity + ClayPercentage + aridityIndexThornthwaite 
+ continentality + minTempWarmest + PETWettestQuarter + OrganicCarbon + PhCaCL + Slope + bio2 
+ bio15 + bio18 + bio19
```
...
## no alpha warning
phyloglmstep(myco_formula_4a, starting.formula = NULL, data=GIS_myco, phy=tree_myco, 
...
myco_best_model_no_alpha <- mycorrhiza ~ 1 + BulkDensity + ClayPercentage + minTempWarmest 
+ PETWettestQuarter + OrganicCarbon + PhCaCL + bio2 + bio15 + bio19
