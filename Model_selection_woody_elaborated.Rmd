...
# 27. With bio8 
woody_formula_27 <- woody ~ Aspect + BulkDensity + ClayPercentage + minTempWarmest + monthCountByTemp10 + PETDriestQuarter + PETseasonality + OrganicCarbon + PhCaCL + Slope + bio14 + bio15 + bio18 + bio19
...
phylostep(formula = woody_formula_9c, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "BM", direction = "forward", trace = 2)
...
#define formula components and run function (both)
phylostep(formula = woody_formula_34a, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "OUrandomRoot", direction = "both", trace = 2, lower.bound = 0, upper.bound = 1000)
