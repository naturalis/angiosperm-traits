...
phylostep(formula = woody_formula_19, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "BM", direction = "forward", trace = 2)
 
#define formula components and run function (both)
phylostep(formula = woody_formula_5c, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "BM", direction = "both", trace = 2)
...
#define formula components and run function (both)
phylostep(formula = woody_formula_33, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "OUrandomRoot", direction = "both", trace = 2, lower.bound = 0, upper.bound = 1000)
...
#define formula components and run function (both)
phylostep(formula = woody_formula_13, starting.formula = woody_starting_formula, data = GIS_woody, phy = tree_woody, model = "OUfixedRoot", direction = "both", trace = 2, lower.bound = 0, upper.bound = 1000)
