...
vif(GIS_crops[,c(3:5, 14, 18, 20, 22:24, 38, 39, 40, 43)]) 
#added 40
```
...
vif(GIS_crops[,c(3:5, 14, 19, 20, 22:24, 28, 37, 39, 43)]) 
vif(GIS_crops[,c(3:5, 14, 20, 22:24, 26, 28, 39, 40, 43)]) 
vif(GIS_crops[,c(3:5, 14, 20, 22:24, 28, 39, 42, 43)]) 
...
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 31, 37, 39)]) 
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 37, 39, 43)]) 
#added 31, 43
```
...
vif(GIS_crops[,c(3:5, 14, 18, 20, 22:24, 26, 38, 40, 43)]) 
#added 40
```
...
vif(GIS_crops[,c(3, 5, 14, 18, 20, 22, 24, 28, 38, 43)]) 
vif(GIS_crops[,c(3, 5, 18, 20, 22, 24, 28, 34, 43)]) 
vif(GIS_crops[,c(3, 5, 18, 20, 22, 24, 28, 41, 43)]) 
#added 14, 34, 38, 41
```
...
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 26, 39, 40)]) 
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 26, 39, 42)]) 
#added 40, 42
```
...
vif(GIS_crops[,c(3:6, 14, 20, 22:24, 37, 38, 43)]) 
```
...
vif(GIS_crops[,c(3:5, 7, 13, 14, 20, 22:24, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 18, 20, 22:24, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 20, 22:24, 26, 31, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 20, 22:24, 28, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 20, 22:24, 30, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 20, 22:24, 33, 37, 43)]) 
vif(GIS_crops[,c(3:5, 7, 14, 20, 22:24, 35, 37, 43)]) 
...
vif(GIS_crops[,c(3:5, 9, 14, 19, 20, 22:24, 37, 38, 43)]) 
#added 19
```
...
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 26, 42)]) 
vif(GIS_crops[,c(3:5, 9, 10, 14, 17, 20, 22:24)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 18, 20, 22:24)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 28)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 31)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 37)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 39)]) 
vif(GIS_crops[,c(3:5, 10, 14, 17, 20, 22:24, 40)]) 
...
vif(GIS_crops[,c(3:5, 8, 11, 14, 20, 22:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 11, 14, 19, 20, 22:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 11, 14, 20, 22:24, 26, 38, 43)]) 
#added 8, 19, 26
```
...
vif(GIS_crops[,c(3:5, 13, 14, 19, 20, 22:24, 37, 38, 43)]) 
#added 19
```
...
vif(GIS_crops[,c(3:5, 8, 14, 20:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 14, 19, 20:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 14, 20:24, 26, 38, 43)]) 
#added 8, 19, 26
```
...
vif(GIS_crops[,c(3:5, 8, 14, 20, 22:25, 38, 43)]) 
vif(GIS_crops[,c(3:5, 14, 19, 20, 22:25, 38, 43)]) 
vif(GIS_crops[,c(3:5, 14, 20, 22:26, 38, 43)]) 
#added 8, 19, 26
```
...
vif(GIS_crops[,c(3:5, 14, 19, 20, 22:24, 27, 37, 38, 43)]) 
vif(GIS_crops[,c(3:5, 14, 20, 22:24, 26, 27, 37, 38, 43)]) 
#added 19, 26
```
...
vif(GIS_crops[,c(3:5, 17, 20, 22:24, 26, 29, 37, 38, 43)]) 
#added 26
```
...
vif(GIS_crops[,c(3:5, 14, 19, 20, 22:24, 30, 37, 38, 43)]) 
#added 19
```
...
vif(GIS_crops[,c(3:5, 14, 17, 19, 22:24, 32, 37, 38, 43)]) 
#added 19
```
...
vif(GIS_crops[,c(3:5, 14, 20, 22:24, 26, 33, 37, 38, 43)]) 
#added 26
```
...
vif(GIS_crops[,c(3:5, 17, 20, 22:24, 26, 34, 37, 38, 43)]) 
#added 26
```
...
vif(GIS_crops[,c(3:5, 14, 19, 20, 22:24, 35, 37, 38, 43)]) 
#added 19
```
...
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 26, 38, 40, 43)]) 
#added 26
```
...
vif(GIS_crops[,c(3:5, 14, 17, 20, 22:24, 26, 37, 41)]) 
#added 26
```
...
vif(GIS_crops[,c(3:5, 14, 17, 18, 20, 22:24, 38, 42)]) 
...
vif(GIS_crops[,c(3:5, 8, 12, 14, 20, 22:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 12, 14, 19, 20, 22:24, 38, 43)]) 
vif(GIS_crops[,c(3:5, 12, 14, 20, 22:24, 26, 38, 43)]) 
#added 8, 19, 26
```
