...
hv.AM <- hypervolume(raw_AM, method = 'svm', name = 'AM', svm.nu = 0.001)
hv.EM <- hypervolume(raw_EM, method = 'svm', name = 'EM',  svm.nu = 0.001)

hv.list <- hypervolume_join(hv.AM,hv.EM)
plot(hv.list,show.3d = F)
```
...
# calculate hypervolume
hv.non.predom <- hypervolume(raw_non_predom, method = 'svm', name = 'non predomesticated', svm.nu = 0.001)
hv.predom <- hypervolume(raw_predom, method = 'svm', name = 'predomesticated',  svm.nu = 0.001)

hv.list <- hypervolume_join(hv.non.predom,hv.predom)
plot(hv.list,show.3d = F)
...
raw_non_woody <- raw_woody_full %>%
    subset(woody == 0) %>% 
    select(monthCountByTemp10, PETWettestQuarter, OrganicCarbon,
    PhCaCL, Slope, bio5)
...
# calculate hypervolume
hv.non.woody <- hypervolume(raw_non_woody, method = 'svm', name = 'non woody', svm.nu = 0.001)
hv.woody <- hypervolume(raw_woody, method = 'svm', name = 'woody',  svm.nu = 0.001)

hv.list <- hypervolume_join(hv.non.woody,hv.woody)
plot(hv.list,show.3d = F)
plot(hv.list,show.3d = T)
```