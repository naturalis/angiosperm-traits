...
serve as the 0 state. These plants will come from the other two databases. 
```{r}
#load domestication, original myc and original swo

#combine myc and swo

#make a sub-selection of myc+swo that does not contain the domestication plants

#take a random sample of this sub-tree to be included in the domestication part

#add a 0 to the domesticated column for these new plants

#add this to the domestication database 
