...
phyloglm(formula = , data = GIS_woody, phy = tree_woody, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = )
```
...
# BM
model_BM_woody <- phyloglm(woody_formula_24a, data = GIS_woody, phy = tree_woody, method = "logistic_MPLE", btol = 10, log.alpha.bound = 4, start.beta=NULL, start.alpha=NULL, boot = 0, full.matrix = TRUE)
    #again the estimate of 'alpha' is almost equal to the upper bound you give.
...
# Compare models
compare_performance(model_BM_woody, model_OU_woody, rank = TRUE)
```
