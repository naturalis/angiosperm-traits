...
```{r define formula}
# 22a. With bio5
woody_formula_22a <- woody ~ Aspect + BulkDensity + ClayPercentage + monthCountByTemp10 
+ PETDriestQuarter + PETWettestQuarter + OrganicCarbon + PhCaCL + Slope + bio2 + bio5 + bio14 
+ bio15 + bio18 + bio19
```
...
woody_best_model <- woody ~ 1 + monthCountByTemp10 + PETWettestQuarter + OrganicCarbon + PhCaCL 
+ Slope + bio5 + bio14
...
### Second round
The bio14 variable was not significant, so we will leave that out and do the phyloglm optimization 
again. 

```{r}
#construct best model
woody_best_model2 <- woody ~ 1 + monthCountByTemp10 + PETWettestQuarter + OrganicCarbon + PhCaCL 
+ Slope + bio5
...
### Define final model
```{r}
final_model_woody <- woody ~ 1.78041 - 2.20071*monthCountByTemp10 + 0.28208*PETWettestQuarter 
+ 1.28682*OrganicCarbon - 1.07275*PhCaCL - 0.98976*Slope + 1.48267*bio5
```
