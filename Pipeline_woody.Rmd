...
#define formula components and run function (forward)
phylostep(formula = , starting.formula = woody ~ 1, data = GIS_woody, phy = tree_woody, model = "BM", direction = "both", trace = 2)
```
...
#define formula components and run function (forward)
phylostep(formula = , starting.formula = woody ~ 1, data = GIS_woody, phy = tree_woody, model = "OUrandomRoot", direction = "forward", trace = 2)

#define formula components and run function (forward)
phylostep(formula = , starting.formula = woody ~ 1, data = GIS_woody, phy = tree_woody, model = "OUrandomRoot", direction = "both", trace = 2)
```
...
#define formula components and run function (forward)
phylostep(formula = , starting.formula = woody ~ 1, data = GIS_woody, phy = tree_woody, model = "OUfixedRoot", direction = "forward", trace = 2)

#define formula components and run function (forward)
phylostep(formula = , starting.formula = woody ~ 1, data = GIS_woody, phy = tree_woody, model = "OUfixedRoot", direction = "both", trace = 2)
```
