...
phylostep(formula = myco_formula_24, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "BM", direction = "both", trace = 2)
...
#define formula components and run function (forward)
phylostep(formula = myco_formula_8b, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "forward", trace = 2, lower.bound = 0.001, upper.bound = 1000)
 
#define formula components and run function (both)
phylostep(formula = myco_formula_50, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "both", trace = 2, lower.bound = 0.001, upper.bound = 1000)
