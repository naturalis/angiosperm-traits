...
myco_formula_8d <- mycorrhiza ~ BulkDensity + climaticMoistureIndex + OrganicCarbon
...
phylostep(formula = myco_formula_7a, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "BM", direction = "forward", trace = 2)
 
#define formula components and run function (both)
phylostep(formula = myco_formula_8c, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "BM", direction = "both", trace = 2)
...
#define formula components and run function (forward)
phylostep(formula = myco_formula_8c, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUrandomRoot", direction = "forward", trace = 2, lower.bound = 0.00000000001, upper.bound = Inf)
 
#define formula components and run function (both)
phylostep(formula = myco_formula_8c, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUrandomRoot", direction = "both", trace = 2, lower.bound = 0, upper.bound = 90000)
...
#define formula components and run function (forward)
phylostep(formula = myco_formula_8d, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "forward", trace = 2, lower.bound = 0.000001, upper.bound = 1000)
 
#define formula components and run function (both)
phylostep(formula = myco_formula_8c, starting.formula = myco_starting_formula, data = GIS_myco, phy = tree_myco, model = "OUfixedRoot", direction = "both", trace = 2, starting.value = "ten")
