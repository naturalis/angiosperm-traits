...
phyloglmstep(crops_formula_13, starting.formula = NULL, data=GIS_crops, phy=tree_crops, 
...
model_crops <- phyloglm(formula = crops_best_model, data = GIS_crops, phy = tree_crops, method = "logistic_MPLE", btol = 100, log.alpha.bound = 8)
...
model_check_crops <- glm(domestication ~ 1 + ClayPercentage + PETWarmestQuarter, data = GIS_crops, family = binomial())
