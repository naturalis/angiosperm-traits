...
phylostep(formula = crops_formula_11a, starting.formula = crops_starting_formula, data = GIS_crops, phy = tree_crops, model = "BM", direction = "both", trace = 0)

#OUfixedRoot, both: define formula components and run function 
phylostep(formula = crops_formula_18, starting.formula = crops_starting_formula, data = GIS_crops, phy = tree_crops, model = "OUfixedRoot", direction = "both", trace = 0, lower.bound = 0.001, upper.bound = 1000)
```
...
phyloglmstep(crops_formula_11a, phy = tree_crops, data = GIS_crops)
```
...
phyloglm(formula = , data = GIS_crops, phy = tree_crops, method = "logistic_MPLE", btol = , log.alpha.bound = , start.beta = , start.alpha = , boot = , full.matrix = )
```
