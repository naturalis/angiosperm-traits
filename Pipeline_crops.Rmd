...
For full script and outcomes of the selection process, see "Model_selection_crops"
```{r model selection BM}
#load required package
library(phylolm)

#define function components and run function 
phylostep(formula = ???, starting.formula = crops_starting_formula, data = GIS_crops, phy = tree_crops, model = "???", direction = "???", trace = 2)
```
