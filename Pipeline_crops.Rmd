...
phylostep(formula = crops_formula_10a, starting.formula = crops_starting_formula, data = GIS_crops, phy = tree_crops, model = "BM", direction = "both", trace = 2)

#OUfixedRoot, both: define formula components and run function 
phylostep(formula = crops_formula_35, starting.formula = crops_starting_formula, data = GIS_crops, phy = tree_crops, model = "OUfixedRoot", direction = "both", trace = 2, lower.bound = 0.001, upper.bound = 1000)
```
